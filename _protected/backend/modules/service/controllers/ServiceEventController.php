...
use backend\modules\service\models\search\ServiceEventSearch;
...
class ServiceEventController extends Controller
{
    ...
    /**
     * Displays a single ServiceEvent model.
     * @param integer $id
     * @return mixed
     */
    ...
    {
        if (($model = ServiceEvent::find()->deleted()->andWhere(['id' => $id])->one()) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
