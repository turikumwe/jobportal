...
use backend\modules\service\models\search\ServiceJobSearch;
...
class ServiceJobController extends Controller {
        ...
        if ($request->isAjax) {
            ...
            if ($request->isGet) {
                ...
                return [
                    ...
                    'title' => "Create new ServiceJob",
                    'content' => '<span class="text-success">Create ServiceJob success</span>',
                    'footer' => Html::button('Close', ['class' => 'btn btn-default pull-left', 'data-dismiss' => "modal"]) .
    ...
    protected function findModelrestore($id) {
        if (($model = ServiceJob::find()->deleted()->andWhere(['id' => $id])->one()) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
