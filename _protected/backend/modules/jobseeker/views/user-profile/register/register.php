...
<div class="vd_content-section clearfix">
    ...
    <div class="<?= Yii::$app->getSession()->getFlash('alert')["options"]["class"]?>">
            <center><h5><?= Yii::$app->getSession()->getFlash('alert')['body']?></h5></center>
    </div>
    <?php } ?>
    ...
    <div class="row">
        ...
        <div class="site-register">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <?php $form = ActiveForm::begin(['id' => 'form-register-jobseeker']); ?>

                        <div class="well"><?php include('userForm.php');?></div>

                        <div class="well"><?php include('identificationForm.php');?></div>

                        <div class="well"><?php include('educationForm.php');?></div>
