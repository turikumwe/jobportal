...
<div class="js-skill-form">
    ...
    <?= $form->field($model, 'skill_level_id')->widget(\kartik\widgets\Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\backend\models\SSkillLevel::find()->orderBy('id')->asArray()->all(), 'id', 'level'),
        'options' => ['placeholder' => Yii::t('app', 'Skill level')],
        'pluginOptions' => [
            'allowClear' => true
        ],
    ]); ?>
