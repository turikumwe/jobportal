...
return [
    ...
    [
        ...
        'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\backend\models\SIsco08Level4::find()->asArray()->all(), 'id', 'occupation'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Occupation', 'id' => 'grid--occupation_id']
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'exact_position',
    ],
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'experience_in_this_occupation',
    ],
    // [
        // 'class'=>'\kartik\grid\DataColumn',
