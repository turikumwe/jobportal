...
return [
    ...
    [
        'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'user_id',
        'label'=>'Apprenticeship applicant',
        ...
        'filterType' => GridView::FILTER_SELECT2,
                ...
                'filterInputOptions' => ['placeholder' => 'Apprenticeship applicant', 'id' => 'grid--user_id']
    ],
    [
                'attribute' => 'apprenticeship_id',
                'label' => Yii::t('app', 'Apprenticeship title'),
                ...
                'filterInputOptions' => ['placeholder' => 'Apprenticeship title', 'id' => 'grid--apprenticeship_id']
            ],
    [
        'class'=>'\kartik\grid\DataColumn',
