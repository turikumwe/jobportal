...
use backend\modules\jobseeker\models\search\JsEducationSearch;
...
class JsEducationController extends Controller
{
    ...
    {    
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Deleted jobseeker Education",
    ...
    {
        if (($model = JsEducation::find()->deleted()->andWhere(['id' => $id])->one()) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
