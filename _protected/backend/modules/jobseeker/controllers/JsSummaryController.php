...
use backend\modules\jobseeker\models\search\JsSummarySearch;
...
class JsSummaryController extends Controller
{
    ...
    {    
     ...
     /**
     * Lists all deleted Summary models.
     * @return mixed
     */
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new JsSummary",
                    'content'=>'<span class="text-success">Create JsSummary success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {
        if (($model = JsSummary::find()->deleted()->andWhere(['id' => $id])->one()) !== null) {
            return $model;
        } else {
            throw new NotFoundHttpException('The requested page does not exist.');
        }
