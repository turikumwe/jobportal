...
class JsEventApplicationSearch extends JsEventApplication
{
    ...
    {
        return [
            [['id', 'user_id', 'even_id', 'area_of_expertise_id', 'employment_status_id', 'special_assistance_id', 'created_by', 'deleted_by', 'updated_by'], 'integer'],
    ...
    public function search($params, $restore=null)
    {
        if(is_null($restore)){
            ...
            $query = JsEventApplication::find()->deleted();
        }
