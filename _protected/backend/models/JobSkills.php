...
class JobSkills extends \yii\db\ActiveRecord {
    ...
    public static function find() {
        ...
        return $query->where(['jobskills.deleted_by' => 0]);
    }

    public function findByJobId($job_id) {

        $skills = JobSkills::find()->where(['jobskills.deleted_by' => 0])->andWhere(['job_id' => $job_id])->asArray()->all();
