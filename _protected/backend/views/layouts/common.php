...
//$image = Yii::$app->user->identity->userProfile->getAvatar($this->assetManager->getAssetUrl($bundle, 'img/anonymous.jpg'));

$image = '/bundle/img/anonymous.jpg';
?>
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li id="timeline-notifications" class="notifications-menu">
                        <?php echo Html::a(Yii::t('backend', 'Frontend'), ['/../..'], ['class' => 'user-header light-blue']) ?>
                    </li>
