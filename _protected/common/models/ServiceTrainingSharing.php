...
/**
 * This is the model class for table "{{%service_training_sharing}}".
 *
 * @property int $id
 * @property int $user_id Sender
 * @property int $job_seeker_id Receiver
 * @property int $training_id Training to be shared
 * @property string $message ant kind of message to motivate the receiver to apply for the training
 ...
 */
class ServiceTrainingSharing extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%service_training_sharing}}';
    }
    ...
    {
        return [
            [['user_id', 'job_seeker_id', 'training_id'], 'required'],
            [['user_id', 'job_seeker_id', 'training_id', 'created_by', 'deleted_by', 'updated_by'], 'integer'],
            [['message'], 'string'],
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\ServiceTrainingSharingQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\ServiceTrainingSharingQuery(get_called_class());
        return $query->where(['service_training_sharing.deleted_by' => 0]);
    }
