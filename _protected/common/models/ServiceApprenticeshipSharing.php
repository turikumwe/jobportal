...
/**
 * This is the model class for table "{{%service_apprenticeship_sharing}}".
 *
 * @property int $id
 * @property int $user_id Sender
 * @property int $job_seeker_id Receiver
 * @property int $apprenticeship_id Apprenticeship to be shared
 * @property string $message ant kind of message to motivate the receiver to apply for the apprenticeship
 ...
 */
class ServiceApprenticeshipSharing extends \yii\db\ActiveRecord
{
    ...
    {
        return '{{%service_apprenticeship_sharing}}';
    }
    ...
    {
        return [
            [['user_id', 'job_seeker_id', 'apprenticeship_id'], 'required'],
            [['user_id', 'job_seeker_id', 'apprenticeship_id', 'created_by', 'deleted_by', 'updated_by'], 'integer'],
            [['message'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'apprenticeship_id' => Yii::t('common', 'Apprenticeship title'),
    ...
    /**
     * {@inheritdoc}
     * @return \common\models\query\ServiceApprenticeshipSharingQuery the active query used by this AR class.
     */
    public static function find()
    {
        $query = new \common\models\query\ServiceApprenticeshipSharingQuery(get_called_class());
        return $query->where(['service_apprenticeship_sharing.deleted_by' => 0]);
    }
