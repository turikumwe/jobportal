 ...
 */
class JobEducationField extends \yii\db\ActiveRecord {
    ...
    public function attributeLabels() {
        return [
            ...
            'field_id' => Yii::t('backend', 'Education Field'),
    ...
    public static function find() {
        ...
        return $query->where(['job_education_fields.deleted_by' => 0]);
    }

    public function findByJobId($job_id) {

        $skills = JobEducationField::find()->where(['job_education_fields.deleted_by' => 0])->andWhere(['job_id' => $job_id])->asArray()->all();
