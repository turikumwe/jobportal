...
<div class="pxp-dashboard-content">
    <?php 
    include(Yii::$app->getModule('mediator')->basePath . "/views/layouts/admin_top_header.php") ?>
    ...
    <div class="pxp-dashboard-content-details">
        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-6">
                <h2 class="mt-4 mt-xl-0">My Job seeker profile completion</h2>
                <div class="mt-3 mt-lg-4 pxp-dashboard-chart-container">
                    <div class="row justify-content-between align-content-center mb-4">
                        <div class="col-auto">
