...
<div class="user-profile-index">
    <div id="ajaxCrudDatatable">
        ...
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => '',
                'heading' => '<font color="#000000">Report Event stat <a href="'.Yii::getAlias('@frontendUrl') . '/mediator/report-events-stat/export-data'.'"><i class="fa fa-file-excel-o"> Export</i>',
