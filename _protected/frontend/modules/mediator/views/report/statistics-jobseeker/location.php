...
<div class="user-profile-index">
    ...
    <div id="ajaxCrudDatatable">
        ...
        GridView::widget([
            ...
            'columns' => require(__DIR__ . '/_location.php'),
            'toolbar' => [
                ['content' =>
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="fa fa-list"></i> User Profiles listing <a href="' . Yii::getAlias('@frontendUrl') . '/mediator/report/export-data' . '"><i class="fa fa-file-excel-o"> Export</i>',
