...
$gfLocation = function ($model, $key, $index, $widget) {
    ...
    return [
        ...
        'content' => [              // content to show in each summary cell
            0 => Yii::t('app','Summary ( '.$model->jsAddress->district->district.')' ),
            5 => GridView::F_SUM,
        ],
...
$gfEducationLevel = function ($model, $key, $index, $widget) {
    return [
        'mergeColumns' => [[3, 4]], 
        'content' => [              // content to show in each summary cell
            3 => Yii::t('app','Summary ( '.(isset($model->jsEducation))? $model->jsEducation->educationLevel->level:''.')' ),
            5 => GridView::F_SUM,
        ],
        'contentFormats' => [      // content reformatting for each summary cell
            3 => ['class' => 'text-left'],
...
return [
    ...
    [
        ...
        'value'      => 'jsAddress.district.district',
        'filterType' => GridView::FILTER_SELECT2,
            'filter' => ArrayHelper::map(SDistrict::find()->orderBy('district')->asArray()->all(), 'id', 'district'), 
            'filterWidgetOptions' => [
                'pluginOptions' => ['allowClear' => true],
            ],
            'filterInputOptions' => ['placeholder' => 'District'],
        'width' => '250px',
        'pageSummary' => 'Total',
