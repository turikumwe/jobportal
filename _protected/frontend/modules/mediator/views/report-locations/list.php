...
<div class="user-profile-index">
    <div id="ajaxCrudDatatable">
        ...
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => '',
                'heading' => '<font color="#000000">Locations Report <a href="'.Yii::getAlias('@frontendUrl') . '/mediator/report-locations/export-databy-district'.'"><i class="fa fa-file-excel-o"> Export</i>',
