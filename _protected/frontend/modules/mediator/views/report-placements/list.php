...
<div class="user-profile-index">
    <div id="ajaxCrudDatatable">
        ...
        <?=GridView::widget([
           ...
           'panel' => [
              'type' => '',
            'heading' => '<i class="glyphicon glyphicon-list"></i> Placement Report <a href="'.Yii::getAlias('@frontendUrl') . '/mediator/report-placements/export-data'.'"><i class="fa fa-file-excel-o"> Export</i>',
