		...
		<div class="panel-body">
		    <table class="table">
		        ...
		        <?php foreach ($job_opportinities as $opportunity) { ?>
		            <tr>
		                <td>
		                    <a href='<?= Url::to(["/mediator/report-opportunities/job?opportunity=".$opportunity->id], true) ?>'> 
...
<div class="panel-body">
    <table class="table">
        ...
        ?>
            <tr>
                <td>
                    <a href='<?= Url::to(["/mediator/report-opportunities/event?opportunity=".$opportunity->id], true) ?>'> 
                        <?=ucwords($opportunity->name)?> 
