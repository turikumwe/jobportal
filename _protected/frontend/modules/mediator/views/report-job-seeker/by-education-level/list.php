...
<div class="user-profile-index">
    <div id="ajaxCrudDatatable">
        ...
        <?=GridView::widget([
            ...
            'toggleDataContainer' => ['class' => 'btn-btn-success'],
            ...
            'panel' => [
                'type' => '',
                'heading' => '<font color="#000000">Number of Job Seekers by Education Field <a href="'.Yii::getAlias('@frontendUrl') . '/mediator/report-job-seeker/export-databy-education'.'"><i class="fa fa-file-excel-o"> Export</i>',
