...
<div class="user-profile-index">
    <div id="ajaxCrudDatatable">
        ...
        <?=GridView::widget([
            ...
            'panel' => [
                'type' => '',
                'heading' => '<font color="#000000">Number of Job Seekers by District <a href="'.Yii::getAlias('@frontendUrl') . '/mediator/report-job-seeker/export-databy-district'.'"><i class="fa fa-file-excel-o"> Export</i>',
