            ...
            <div class="row justify-content-between align-content-center">
                ...
                <div class="col-auto order-2 order-sm-1">
                    <div class="pxp-company-dashboard-jobs-bulk-actions mb-3">
                        ...
                        <?php $form = ActiveForm::begin(['id' => 'search_by_date', 'method' => 'GET', 'action' => Yii::$app->link->frontendUrl('/mediator/report-mediator-service')]); ?>
                            ...
                            <tr>
                                <td>
                                    <select class="form-select" id="opportunity_type" name="mediator">
                                        ...
                                        <?php
                                        if (count($public_mediators) > 0) {
                                            foreach ($public_mediators as $mediator) {
                                                ?>
