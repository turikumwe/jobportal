...
$url = (Yii::$app->user->can('user')) ? '/jobseeker/user-profile/update' : '/jobseeker/user-profile/update?idOtherProfile='.$_GET['idOtherProfile'];
?>
...
<div class="user-profile-form">
    ...
    <table class='table'>
       <!--  <tr style='background-color: #f5f5f5'>
        ...
        <tr>
            ...
            <td> <?= $form->field($model, 'id_number')->textInput(['maxlength' => true, 'readOnly' => TRUE]) ?></td>

            <td> <?= $form->field($model, 'passport_number')->textInput(['maxlength' => true, 'readOnly' => TRUE]) ?></td>
    ...
    <tr>
        ...
        <td> <?= $form->field($model, 'dob')->textInput(['readOnly' => TRUE]) ?></td>
