        ...
        ?>
           	<tr>
				...
				<td width="20%"  class="pxp-dashboard-table-options">
               	...
               	<?php if(!isset($_GET['js'])) { ?>
               	<a href="#casemanagement" style="background-color: #e9e9e9"  onClick='remove(<?= $casemanagement->id?>,"js-casemanagement","casemanagement")'>
               		<button class="fa fa-trash-o action-button-danger" aria-hidden="true"  ></button>
               	</a>
               	<?php } ?>
               </center>
               </td>
