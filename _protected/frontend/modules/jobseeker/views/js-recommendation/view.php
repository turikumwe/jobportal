...
<div class="vd_content-section clearfix">
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="tabs widget">
                <ul class="nav nav-tabs widget">
                    <li> 
                        <?= Html::a('<i class="glyphicon glyphicon-home"></i>', ['./user-profile']) ?>
                    </li>
                    <li class="active"> 
        ...
        <div class="col-sm-3">
           ...
           <?php if(Yii::$app->getSession()->hasFlash('recommendation') ) {?>
            <div class="well <?= Yii::$app->getSession()->getFlash('recommendation')["options"]["class"]?>" role="alert">
                <center><h4><?= Yii::$app->getSession()->getFlash('recommendation')['body']?>&nbsp;<i class="glyphicon glyphicon-ok"></i></h4></center>
            </div>
            <?php } ?>
        </div> 
    </div>
