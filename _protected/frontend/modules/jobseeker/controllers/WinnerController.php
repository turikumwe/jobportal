...
use frontend\modules\jobseeker\models\WinnerSearch;
...
class WinnerController extends Controller
{
        ...
        return [
            ...
            'access' => [
                ...
                'rules' => [
                    ...
                    //     //     return Yii::$app->controller->redirect(['/jobseeker/winner']);
                    //     // }
                    // ],
                ]
            ],
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Winner",
                    'content'=>'<span class="text-success">Create Winner success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Winner model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Winner model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        // Decode winning numbers
        $i=0;
        $arry = array();
        $sortarry = array();
        $wns = new WinningNumber();
        $wn = $wns::find()->orderBy(['number' => SORT_ASC])->all();
        foreach ($wn as $wn){
            $arry[] = (int)base64_decode($wn['number']);
        }
        sort($arry);
