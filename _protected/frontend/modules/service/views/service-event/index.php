...
<section class="pxp-page-header-simple">
    <div class="pxp-container">
        ...
        <div class="pxp-hero-subtitle pxp-text-light">Search in <strong><?= $event_count; ?></strong> active trainings</div>
        ...
        <div class="pxp-hero-form pxp-hero-form-round pxp-large pxp-has-border mt-3 mt-lg-4">
            ...
            <div class="col-12 col-lg">
                <div class="input-group mb-3 mb-lg-0">
                    ...
                    <input type="text" class="form-control" placeholder="Training Title" name="title">
                </div>
            </div>
    ...
    <div class="pxp-container">
        <div class="pxp-jobs-list-top">
            <div class="row justify-content-between align-items-center">
                <div class="col-auto">
                    <h2><span class="pxp-text-light">Showing</span> <?= $event_count; ?> <span class="pxp-text-light">trainings</span></h2>
                </div>
                <div class="col-auto">
                            ...
                            <div class="pxp-jobs-card-1-top">
                                ...
                                <div class="row" style="margin-top:20px;">
                                    <div class="col-md-6 col-xl-4 col-xxl-12">
                                        <?php $descr = limit_text(strip_tags($event->description_event), 20); ?>
                                        <span style=""><?php echo $descr; ?><a href="<?= Yii::$app->link->frontendUrl('/service/service-event/view?id=' . $event->id) ?>" class="">Read more ...</a></span>
                                    </div>
                                </div>
                                <?php if ($event->always_open_flag == 0) { ?>
                                    <div class="row" style="margin-top:20px;">
