...
<div class="pxp-dashboard-content">
    ...
    <div class="pxp-dashboard-content-details">
        <div class="row">
            <div class="col-md-6">
                <h1>Manage events</h1>
                <span class="pxp-text-light">Detailed list with all your Organization events.</span>
            </div>
            <div class="col-md-6">
                <?php
                ...
                if (\common\models\User::isFromEmployer(Yii::$app->user->identity->id)) {
                    if ($employer->employerProfile->is_verified == 1) {
                        ?>
                        <span style="float: right;"><a href="<?= Yii::getAlias('@frontendUrl') . '/service/service-event/post-event'; ?>" class="btn rounded-pill pxp-nav-btn">Post new event</a></span>
                        <?php
                    } else {
                        ?>
            ...
            <div class="row justify-content-between align-content-center">
                ...
                <div class="col-auto order-1 order-sm-2">
                    <div class="pxp-company-dashboard-jobs-search mb-3">
                        <div class="pxp-company-dashboard-jobs-search-results me-3"><?= $events_count; ?> events</div>
                        <div class="pxp-company-dashboard-jobs-search-search-form">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="title" class="form-control" placeholder="Search events...">
                            </div>
                            <?php ActiveForm::end(); ?>
                        </div>
                    </div>
                                    ...
                                    <td>
                                        <div class="pxp-dashboard-table-options">
                                            <ul class="list-unstyled ">
                                                <li><a href="<?= Yii::$app->link->frontendUrl('/service/service-event/update-event?id=' . $event->id) ?>"><button title="Edit" type="button" class="action-button"><span class="fa fa-pencil"></span></button></a></li>
