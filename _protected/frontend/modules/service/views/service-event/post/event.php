...
<div class="service-event-form">
    ...
    <div class="col-md-12 mb-3">
        <?= $form->field($model, 'event_title')->textInput(['maxlength' => true, 'placeholder' => 'Enter Event Title']) ?>
    </div>


    <div class="col-md-12 mb-3" style="display: none">
        <?= $form->field($model, 's_opportunity_id')->hiddenInput(['value' => '2'])->label(false); ?>
    ...
    <div class="col-md-12 mb-3">
        <?= $form->field($model, 'venue')->textInput(['maxlength' => true, 'placeholder' => 'Enter Event Venue']) ?>
    </div>
