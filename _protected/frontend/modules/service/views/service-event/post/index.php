...
<div class="pxp-dashboard-content">
    ...
    <div class="pxp-dashboard-content-details">
        <?php if (!$is_update) {
            ?>
            <h1>New training</h1>
            <p class="pxp-text-light">Add a new training to your company's jobs list. Fields with <span style="color:red">*</span> are required</p>
            <?php
        } else {
            ?>
            <h1>Update training</h1>
            <p class="pxp-text-light">Update the registered training. Fields with <span style="color:red">*</span> are required</p>
            <?php
        }
        ?>
