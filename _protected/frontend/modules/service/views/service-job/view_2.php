                            ...
                            <div class="pxp-single-job-options mt-4 col-xl-0">
                                ...
                                if (Yii::$app->user->isGuest) {
                                    ...
                                    <?php
                                        ...
                                        $jobexist = FavoriteJobs::find()->where(['job_id' => $model->id])->all();
                                        if (count($jobexist) > 0) {
                                        ...
                                        if (Yii::$app->user->can('user')) {
                                            if ($model->apply_through_kora_flag == 0) {
                                                ...
                                                if (common\models\JsJobApplication::alreadyApplied($model->id)) {
                                                    ...
                                                    ?>
                                                    <a href="#application-modal" data-bs-toggle="modal" class="btn rounded-pill pxp-card-btn" onclick="set_selected_job(<?= $model->id; ?>)">Apply now</a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    &nbsp;&nbsp;
                        ...
                        <div class="mt-4">
                            ...
                            <p><?php
                                if (isset($model->employer)) {
                                    ...
                                    $coprofile = common\models\EmplSummary::find()->where(['employer_id' => $employer])->one();
                                    if (isset($coprofile)) {
                                        echo $coprofile->professional_profile;
                                    } else {
                                        echo 'N/A';
                                    }
                                }
