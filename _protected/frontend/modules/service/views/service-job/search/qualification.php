...
<div class="panel widget light-widget panel-bd-top">
    <div class="panel-heading">
        <center>
        <h4>
            <b><?= Yii::t("frontend","Qualification") ?></b></h4>
        </center> 
    </div>
    ...
    <?php $form = ActiveForm::begin() ?>
    		<?= $form->field($searchModel, 'education_level_id')->widget(\kartik\widgets\Select2::classname(), [
			        ...
			        'options' => [
			        	'placeholder' => Yii::t('frontend', 'Qualification'),
...
<script>
    function searchByQualification(value) {
        window.location.href= "/service/service-job/index?type=qualification&search="+value;
    }
</script>